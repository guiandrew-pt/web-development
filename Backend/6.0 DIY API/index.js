...
app.get("/filter", async (req, res) => {
  ...
  const specificJoke = jokes.filter((joke) => joke.jokeType === jokeType);
  res.send(specificJoke);
});
...
app.put("/jokes/:id", async (req, res) => {
  ...
  const jokeToReplace = jokes.findIndex((joke) => joke.id === id);

  jokes[jokeToReplace] = correctJoke;

  res.json(correctJoke);
});
...
app.patch("/jokes/:id", async (req, res) => {
  ...
  const fetchTheJoke = jokes.find((joke) => joke.id === id); 
  console.log(fetchTheJoke.jokeText);
  const correctJoke = {
    id: id,
    jokeText: req.body.text || fetchTheJoke.jokeText,
    jokeType: req.body.type || fetchTheJoke.jokeType
  };
